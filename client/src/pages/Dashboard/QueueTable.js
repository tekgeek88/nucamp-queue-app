...
const headCells = [
  ...
  { id: 'owner', align: 'left', disablePadding: false, label: 'Owner' },
  { id: 'ownerEmail', align: 'left', disablePadding: false, label: 'Owner Email' },
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{`${row.owner.firstname} ${row.owner.lastname}`}</TableCell>
